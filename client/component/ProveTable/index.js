...
var thTH = _interopDefault(require('antd/es/locale/th_TH'));
var enUS = _interopDefault(require('antd/es/locale/en_US'));
...
i18nU.use(reactI18next.initReactI18next).init({
  resources: {
    en: {
      translation: en
    },
...
var R2D2Store = /*#__PURE__*/function () {
  function R2D2Store() {
    ...
    this.handleChangePage = mobx.action(function (page) {
      try {
    ...
    this.handleColumnFilter = mobx.action(function (searchColumn, types) {
      try {
    ...
    this.setFetchData = mobx.action(function (func) {
      try {
        _this4.fetchData = mobx.action(function () {
          try {
    ...
    mobx.makeObservable(this, {
      init: mobx.observable,
      data: mobx.observable,
      totalItems: mobx.observable,
      state: mobx.observable,
      fetchSize: mobx.observable,
      filter: mobx.observable,
      searchParams: mobx.observable,
      currentPage: mobx.observable,
      perPage: mobx.observable,
      totalPage: mobx.observable,
      isLoading: mobx.observable,
      setInit: mobx.action,
      handleChangePage: mobx.action,
      handleResetPage: mobx.action,
      handleColumnFilter: mobx.action
    });
  }
...
var useStore = function useStore() {
  var store = React__default.useContext(StoreContext);
...
function R2D2Table(props) {
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MobxProvider, {
    store: Store
  }, /*#__PURE__*/React__default.createElement(LocalTable, props), ";"));
}
var LocalTable = mobxReact.observer(function (props) {
  var _useStore = useStore(),
      r2d2Store = _useStore.r2d2Store;

  var fetchMyAPI = React.useCallback(function () {
    try {
    ...
    return {
      filterDropdown: function filterDropdown(_ref) {
        ...
        return /*#__PURE__*/React__default.createElement("div", {
          ...
          icon: /*#__PURE__*/React__default.createElement(icons.SearchOutlined, null),
          size: "small",
          style: {
            width: 90,
            marginRight: 8
          }
        }, "Search"), /*#__PURE__*/React__default.createElement(antd.Button, {
          onClick: function onClick() {
      ...
      filterIcon: function filterIcon(filtered) {
        return /*#__PURE__*/React__default.createElement(icons.SearchOutlined, {
          style: {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(FilterBar, null), /*#__PURE__*/React__default.createElement(antd.Table, _extends({
...
var FilterBar = mobxReact.observer(function () {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement("div", null, element.title, ' : ', element.searchText, ' ', /*#__PURE__*/React__default.createElement(icons.CloseCircleTwoTone, {
      onClick: function onClick() {
...
var TableStore = /*#__PURE__*/function () {
  function TableStore() {
    ...
    this.setFetchData = mobx.action(function (func) {
      try {
        _this2.fetchData = mobx.action(function () {
          try {
    ...
    this.setModalVisibility = mobx.action(function (_visibility) {
        ...
        try {
          return Promise.resolve(_catch(function () {
            return Promise.resolve(func(_this.primaryKey)).then(function (record) {
              return Promise.resolve(mobx.runInAction(function () {
    ...
    this.setReadRecordHandler = function (func) {
      _this.readRecord = mobx.action(function (record) {
        try {
    ...
    this.setUpdateRecordHandler = function (func) {
      _this.updateRecord = mobx.action(function (record) {
        try {
          return Promise.resolve(func(record)).then(function () {
            mobx.runInAction(function () {
              _this.setModalVisibility(false);
    ...
    this.setUpdateStatusHandler = function (func) {
      _this.statusRecord = mobx.action(function (record) {
        try {
          return Promise.resolve(func(record)).then(function () {
            mobx.runInAction(function () {
              _this.isLoading = false;
    ...
    this.setCreateRecordHandler = function (func) {
      _this.createRecord = mobx.action(function (record) {
        try {
          return Promise.resolve(func(record)).then(function () {
            mobx.runInAction(function () {
              _this.isLoading = false;
    ...
    this.setDeleteRecordHandler = function (func) {
      _this.deleteRecord = mobx.action(function (record) {
        try {
          return Promise.resolve(func(record)).then(function () {
            mobx.runInAction(function () {
              _this.isLoading = false;
    ...
    this.setBulkActionHandler = function (func) {
      _this.bulkActionRecord = mobx.action(function (key) {
        try {
    ...
    mobx.makeObservable(this, {
      ...
      totalPage: mobx.observable,
      isLoading: mobx.observable,
      currentRecord: mobx.observable,
      primaryKey: mobx.observable,
      ActionComponent: mobx.observable,
      actionView: mobx.observable,
      actionTitle: mobx.observable,
      actionWidth: mobx.observable,
      actionFormVisible: mobx.observable,
      getRecord: mobx.observable,
      readRecord: mobx.observable,
      statusRecord: mobx.observable,
      updateRecord: mobx.observable,
      createRecord: mobx.observable,
      deleteRecord: mobx.observable,
      bulkActionRecord: mobx.observable,
      bulkActionSelected: mobx.observable,
      setBulkActionHandler: mobx.action,
      setBulkActionSelected: mobx.action,
      handleResetBulkActionSelected: mobx.action,
      setRowKey: mobx.action,
      setModalVisibility: mobx.action,
      setComponent: mobx.action,
      setInit: mobx.action,
      handleChangePage: mobx.action,
      handleResetPage: mobx.action,
      handleColumnFilter: mobx.action,
      setCurrentRecord: mobx.action,
      setPrimaryKey: mobx.action,
      setPage: mobx.action,
      setGetRecordHandler: mobx.action,
      setReadRecordHandler: mobx.action,
      setUpdateRecordHandler: mobx.action,
      setUpdateStatusHandler: mobx.action,
      setCreateRecordHandler: mobx.action,
      setDeleteRecordHandler: mobx.action,
      setSearchParams: mobx.action,
      setFilter: mobx.action,
      headerStatus: mobx.observable,
      setHeaderStatus: mobx.action,
      resetTableStore: mobx.action
    });
  }
...
var ActionDropDown = React__default.memo(function (_ref) {
  var data = _ref.data,
      record = _ref.record,
      text = _ref.text;
  var menu = /*#__PURE__*/React__default.createElement(antd.Menu, null, data.map(function (Component) {
    return /*#__PURE__*/React__default.createElement(antd.Menu.Item, {
      key: Component.key,
      icon: /*#__PURE__*/React__default.createElement(Component.Icon, null),
      onClick: function onClick() {
  ...
  return /*#__PURE__*/React__default.createElement(antd.Dropdown, {
    overlay: menu
  }, /*#__PURE__*/React__default.createElement(antd.Button, null, text, " ", /*#__PURE__*/React__default.createElement(icons.DownOutlined, null)));
});

var ActionButtonGroup = React__default.memo(function (_ref) {
  var data = _ref.data,
      record = _ref.record;
...
function C3POTable(props) {
  return /*#__PURE__*/React__default.createElement(MobxProvider, {
    store: Store$1
  }, /*#__PURE__*/React__default.createElement(LocalTable$1, props));
}
var RenderForm = mobxReact.observer(function () {
  var _useStore = useStore(),
      tableStore = _useStore.tableStore;

  if (tableStore.ActionComponent && React__default.isValidElement(tableStore.ActionComponent) && typeof tableStore.ActionComponent.type === 'function') {
...
var LocalTable$1 = mobxReact.observer(function (props) {
  var _useStore2 = useStore(),
  ...
  var ActionButton = mobxReact.observer(function (props) {
    var type = props.type;

    if (type === 'dropdown') {
      return /*#__PURE__*/React__default.createElement(ActionDropDown, props);
    } else {
      return /*#__PURE__*/React__default.createElement(ActionButtonGroup, props);
    }
  });
      ...
      return columns.map(function (column) {
        ...
        if (column.action && column.action.length) {
          ...
          column.action.forEach(function (action) {
            ...
            switch (action.type) {
              case 'inlineEdit':
                Icon = icons.EditOutlined || action.icon;
                break;

              case 'edit':
                Icon = icons.EditFilled || action.icon;
                break;

              case 'view':
                Icon = icons.EyeFilled || action.icon;
                break;

              case 'delete':
                Icon = icons.DeleteFilled || action.icon;
                break;

              case 'read':
                Icon = icons.ReadOutlined || action.icon;
                break;

              case 'update-status':
                Icon = icons.UnlockOutlined || action.icon;
                break;
      ...
      expandable: {
        expandedRowRender: function expandedRowRender(record) {
          ...
          props.expandableRows.forEach(function (element, i) {
            item.push( /*#__PURE__*/React__default.createElement(antd.Descriptions.Item, {
              bordered: true,
          ...
          }, /*#__PURE__*/React__default.createElement(antd.Descriptions, {
            bordered: true,
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(RenderForm, null), /*#__PURE__*/React__default.createElement(HeaderTable, {
    bulk: props.bulkAction,
    filter: props.queryHeader
  }), /*#__PURE__*/React__default.createElement(FilterBar$1, null), /*#__PURE__*/React__default.createElement(antd.Table, _extends({
...
var FilterBar$1 = mobxReact.observer(function () {
...
var HeaderTable = mobxReact.observer(function (_ref3) {
  var bulk = _ref3.bulk,
      filter = _ref3.filter;
  ...
  var FilterButton = function FilterButton() {
    ...
    if (filter) {
      filter.forEach(function (E) {
        if (E.type === 'button') {
          render.push( /*#__PURE__*/React__default.createElement(antd.Button, {
            key: E.label,
            icon: /*#__PURE__*/React__default.createElement(E.icon, null),
            onClick: function onClick() {
              var filter = [];
        ...
        if (E.type === 'options') {
          render.push( /*#__PURE__*/React__default.createElement(E.component, {
            key: E.key,
  ...
  var BulkButton = function BulkButton() {
    var menu = {
      "if": function _if(bulk) {
        return /*#__PURE__*/React__default.createElement(antd.Menu, {
    ...
    if (bulk) {
      ...
      }, /*#__PURE__*/React__default.createElement(antd.Button, null, bulk.ButtonName));
    } else {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(BulkButton, null), /*#__PURE__*/React__default.createElement("div", null, FilterButton())), /*#__PURE__*/React__default.createElement("div", {
    style: {
      width: '100%',
      height: '62px',
      borderRadius: '18px',
    ...
    }, /*#__PURE__*/React__default.createElement("div", null, tableStore.rowKey, ' : ', element, ' ', /*#__PURE__*/React__default.createElement(icons.CloseCircleTwoTone, {
      onClick: function onClick() {
...
var R2D2Table$1 = function R2D2Table$1(props) {
  ...
  return /*#__PURE__*/React__default.createElement(reactI18next.I18nextProvider, {
    i18n: i18nU
  }, /*#__PURE__*/React__default.createElement(antd.ConfigProvider, {
    locale: props.lang === 'th' ? thTH : enUS
  }, /*#__PURE__*/React__default.createElement(R2D2Table, props)));
};
var C3POTable$1 = function C3POTable$1(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    locale: props.lang === 'th' ? thTH : enUS
  }, /*#__PURE__*/React__default.createElement(C3POTable, props))));
};

exports.C3POTable = C3POTable$1;
exports.R2D2Table = R2D2Table$1;
